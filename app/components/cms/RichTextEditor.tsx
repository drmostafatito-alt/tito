 ...
 */
const btn =
  "inline-flex h-9 min-w-9 items-center justify-center rounded border border-line bg-white px-2 text-xs font-semibold text-ink hover:bg-slate-50";
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div
        ...
        dir={dir}
        className={`cms-richtext rounded-lg border border-line bg-white px-3 py-2 text-sm text-ink focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-800 ${MIN_HEIGHT[rows] ?? "min-h-[8.4rem]"}`}
