...
export const CMS_LABELS: Record<string, { ar: string; en: string }> = {
  ...
  "cms.ui.systemLanguage": { ar: "اللغة", en: "Language" },
  "cms.f.defaultLocale": { ar: "لغة الزائر الافتراضية", en: "Default visitor language" },
  "cms.f.localeOfferAr": { ar: "عرض العربية", en: "Offer Arabic" },
  "cms.f.localeOfferEn": { ar: "عرض الإنجليزية", en: "Offer English" },
  "cms.f.localeHint": {
    ar: "الزائر الجديد يرى المنصة باللغة الافتراضية حتى يختار لغة أخرى. إلغاء كلتا اللغتين غير مسموح، ويجب أن تكون اللغة الافتراضية ضمن المعروضة.",
    en: "A new visitor sees the platform in the default language until they pick another. At least one language must stay offered, and the default must be one of them.",
  },
