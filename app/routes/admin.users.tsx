    ...
    <div className="flex flex-col gap-6">
              ...
              {selected.size > 0 && (
                <div className="ms-auto flex flex-wrap items-center gap-2">
                  ...
                  <button type="button" onClick={() => setConfirmingSuspend(true)} data-testid="bulk-suspend-open"
                    className="rounded-lg bg-error px-3 py-1.5 text-xs font-medium text-white hover:bg-red-800">
      ...
      >
        ...
        <div className="mt-4 flex justify-end gap-2">
          <button type="button" onClick={() => setConfirmingSuspend(false)} className="rounded-lg border border-line px-4 py-2 text-sm font-medium text-ink-soft hover:bg-sand-100">
