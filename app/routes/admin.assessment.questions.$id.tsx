...
const areaCls = "w-full rounded-lg border border-line bg-white px-3.5 py-2.5 text-sm";
  ...
  return (
    <div className="space-y-4" key={isNew ? "new" : `q-${question?.id ?? ""}`}>
      <nav className="text-sm">
        <Link to="/admin/assessment" className="inline-flex min-h-6 items-center text-ink hover:underline">
      ...
      <Form method="post" className="space-y-4">
        ...
        <Card>
          <CardBody className="space-y-3">
            {isNew ? (
              <div>
                <label className="text-sm font-medium text-ink">{t(locale, "assessment.type")}</label>
            ...
            <div>
              <label htmlFor="q-stem-ar" className="text-sm font-medium text-ink">{t(locale, "assessment.stemAr")}</label>
              <textarea id="q-stem-ar" name="stemAr" required defaultValue={question?.stemAr ?? ""} rows={2} className={areaCls} />
            </div>
            <div>
              <label htmlFor="q-stem-en" className="text-sm font-medium text-ink">{t(locale, "assessment.stemEn")}</label>
              <textarea id="q-stem-en" name="stemEn" required defaultValue={question?.stemEn ?? ""} rows={2} className={areaCls} />
            </div>
            <div className="grid gap-3 sm:grid-cols-3">
              <div>
                <label htmlFor="q-difficulty" className="text-sm font-medium text-ink">{t(locale, "assessment.difficulty")}</label>
            ...
            <CardBody className="space-y-3">
              ...
              {choices.length < 6 && (
                <button
                  ...
                  className="min-h-11 rounded-lg border border-dashed px-4 text-sm text-ink-muted hover:border-ink sm:min-h-0"
                >
        ...
        {!objective && (
          <Card>
            <CardBody className="space-y-3">
              ...
              <div>
                <label htmlFor="q-model-ar" className="text-sm font-medium text-ink">{t(locale, "assessment.modelAnswerAr")}</label>
                <textarea id="q-model-ar" name="modelAnswerAr" defaultValue={question?.modelAnswerAr ?? ""} rows={4} className={areaCls} dir="auto" />
              </div>
              <div>
                <label htmlFor="q-model-en" className="text-sm font-medium text-ink">{t(locale, "assessment.modelAnswerEn")}</label>
        ...
        <Card>
          <CardBody className="space-y-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                <label htmlFor="q-subject" className="text-sm font-medium text-ink">Subject</label>
              ...
              <div>
                <label htmlFor="q-course" className="text-sm font-medium text-ink">Course</label>
              ...
              <div>
                <label htmlFor="q-unit" className="text-sm font-medium text-ink">Unit</label>
              ...
              <div>
                <label htmlFor="q-lesson" className="text-sm font-medium text-ink">Lesson</label>
