                  ...
                  <li key={tpl.id} className="flex flex-wrap items-center gap-2 py-3">
                    ...
                    {!tpl.builtin && (
                      <Form method="post">
                        ...
                        <button type="submit" className="inline-flex min-h-9 items-center rounded-lg border border-error/30 px-3 text-xs font-medium text-error hover:bg-error-soft">
                          {L("cms.ui.delete")}
                        </button>
                      </Form>
                    )}
