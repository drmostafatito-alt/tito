  ...
  return (
    <div className="relative isolate mx-auto flex w-full max-w-md flex-col justify-center px-4 py-12">
      {/* Decorative engraved line-art: outside the card, behind it, aria-hidden,
          never on top of the form fields. */}
      <div aria-hidden="true" className="pointer-events-none absolute -top-6 start-0 hidden h-40 w-40 select-none opacity-[0.07] sm:block">
        <Art name="kant" />
      </div>
      <div aria-hidden="true" className="pointer-events-none absolute -bottom-8 end-0 hidden h-36 w-36 select-none opacity-[0.07] sm:block">
        <Art name="scroll" />
      </div>
