        ...
        {perms.create && (
          <div className="flex gap-2">
            ...
            <Link
              ...
              className="min-h-11 rounded-lg border border-brand-600 px-4 py-2.5 text-sm font-semibold text-ink hover:bg-slate-100 sm:min-h-0"
            >
        ...
        {(perms.grade ? ASSESSMENT_TABS_ALL : ASSESSMENT_TABS_AUTH).map((tb) => (
          <Link
            ...
            className={`rounded-t-lg px-4 py-2 text-sm font-medium ${
              tab === tb ? "border border-b-0 bg-white text-ink" : "text-ink-muted hover:text-ink"
            }`}
          >
        ...
        <>
          <Form method="get" className="flex flex-wrap items-end gap-2" data-testid="question-filters">
            ...
            <input
              ...
              className="h-[42px] min-w-[10rem] flex-1 rounded-lg border border-line bg-white px-3 text-sm"
            />
            ...
            <button type="submit" className="min-h-[42px] rounded-lg border border-line bg-white px-4 text-sm font-medium hover:bg-slate-50">
              ...
              {selected.size > 0 && (
                <div className="ms-auto flex flex-wrap items-center gap-2">
                  <Form method="post">
                    ...
                    <button type="submit" className="rounded-lg border border-line bg-white px-3 py-1.5 text-xs font-medium hover:bg-slate-50">
          ...
          {exams.map((e) => {
            ...
            return (
              <Card key={e.id}>
                <CardBody className="flex flex-wrap items-center justify-between gap-2">
                  <div className="min-w-0">
                    <Link to={`/admin/assessment/exams/${e.id}`} className="truncate text-sm font-medium hover:text-ink">
                  ...
                  <div className="flex items-center gap-2">
                    {e.status === "published" && (
                      <Link to={`/exams/${e.slug}`} className="text-xs text-ink hover:underline">
