...
type Module = typeof import("../public.curriculum.$lessonSlug.js")

type Info = GetInfo<{
  file: "routes/public.curriculum.$lessonSlug.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../public.curriculum.$lessonSlug.js");
}];
