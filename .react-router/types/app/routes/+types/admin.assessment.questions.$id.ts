...
type Module = typeof import("../admin.assessment.questions.$id.js")

type Info = GetInfo<{
  file: "routes/admin.assessment.questions.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../admin.assessment.questions.$id.js");
}];
