...
type Module = typeof import("../learn.$courseSlug.$lessonSlug.js")

type Info = GetInfo<{
  file: "routes/learn.$courseSlug.$lessonSlug.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../learn.$courseSlug.$lessonSlug.js");
}];
