...
type Module = typeof import("../admin.assessment.attempts.$attemptId.js")

type Info = GetInfo<{
  file: "routes/admin.assessment.attempts.$attemptId.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../admin.assessment.attempts.$attemptId.js");
}];
