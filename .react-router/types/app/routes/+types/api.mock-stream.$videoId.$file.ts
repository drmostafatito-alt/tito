...
type Module = typeof import("../api.mock-stream.$videoId.$file.js")

type Info = GetInfo<{
  file: "routes/api.mock-stream.$videoId.$file.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.mock-stream.$videoId.$file.js");
}];
