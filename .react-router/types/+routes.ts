...
type RouteFiles = {
  "root.tsx": {
    id: "root";
    page: "/" | "/__test/email-capture" | "/p/:slug" | "/about" | "/programs" | "/programs/:slug" | "/grades/:slug" | "/subjects/:slug" | "/study" | "/study/:subjectSlug" | "/courses" | "/courses/:slug" | "/courses/:slug/units/:unitId" | "/curriculum/:slug" | "/products/:slug" | "/login" | "/register" | "/forgot-password" | "/reset-password" | "/verify-email-change" | "/set-locale" | "/logout" | "/theme.css" | "/favicon.ico" | "/robots.txt" | "/sitemap.xml" | "/learn/:courseSlug/:lessonSlug" | "/files/:id" | "/api/playback/:videoId" | "/beacons/progress" | "/webhooks/payments/:provider" | "/api/mock-stream/:videoId/:file" | "/dashboard" | "/profile" | "/assignments" | "/assignments/:id" | "/checkout/:productSlug" | "/orders" | "/orders/:orderNumber" | "/activate" | "/profile/security" | "/notifications" | "/admin" | "/admin/cms" | "/admin/cms/templates" | "/admin/cms/pages/:id" | "/admin/cms/preview/:pageId" | "/admin/cms/menus" | "/admin/cms/forms" | "/admin/appearance" | "/admin/seo" | "/admin/content" | "/admin/content/:type/:id" | "/admin/files" | "/admin/videos" | "/admin/entitlements" | "/admin/search" | "/admin/users" | "/admin/teachers" | "/admin/users/:id" | "/admin/students/:id" | "/admin/analytics" | "/admin/audit" | "/admin/security" | "/admin/announcements" | "/admin/assignments" | "/admin/assignments/:id" | "/admin/commerce" | "/admin/commerce/products/:id" | "/admin/commerce/orders/:id" | "/admin/commerce/batches/:id";
  };
  "routes/test.email-capture.tsx": {
    id: "routes/test.email-capture";
    page: "/__test/email-capture";
  };
  "routes/public/layout.tsx": {
    id: "public";
    page: "/" | "/p/:slug" | "/about" | "/programs" | "/programs/:slug" | "/grades/:slug" | "/subjects/:slug" | "/study" | "/study/:subjectSlug" | "/courses" | "/courses/:slug" | "/courses/:slug/units/:unitId" | "/curriculum/:slug" | "/products/:slug" | "/login" | "/register" | "/forgot-password" | "/reset-password" | "/verify-email-change" | "/set-locale";
  };
  ...
  "routes/public.study.tsx": {
    id: "routes/public.study";
    page: "/study";
  };
  "routes/public.study.$subjectSlug.tsx": {
    id: "routes/public.study.$subjectSlug";
    page: "/study/:subjectSlug";
  };
  ...
  "routes/public.curriculum.$slug.tsx": {
    id: "routes/public.curriculum.$slug";
  ...
  "routes/student/layout.tsx": {
    id: "student";
    page: "/dashboard" | "/profile" | "/assignments" | "/assignments/:id" | "/checkout/:productSlug" | "/orders" | "/orders/:orderNumber" | "/activate" | "/profile/security" | "/notifications";
  };
  ...
  "routes/student/assignments.tsx": {
    id: "routes/student/assignments";
    page: "/assignments";
  };
  "routes/student/assignments.$id.tsx": {
    id: "routes/student/assignments.$id";
    page: "/assignments/:id";
  };
  ...
  "routes/admin/layout.tsx": {
    id: "admin-root";
    page: "/admin" | "/admin/cms" | "/admin/cms/templates" | "/admin/cms/pages/:id" | "/admin/cms/preview/:pageId" | "/admin/cms/menus" | "/admin/cms/forms" | "/admin/appearance" | "/admin/seo" | "/admin/content" | "/admin/content/:type/:id" | "/admin/files" | "/admin/videos" | "/admin/entitlements" | "/admin/search" | "/admin/users" | "/admin/teachers" | "/admin/users/:id" | "/admin/students/:id" | "/admin/analytics" | "/admin/audit" | "/admin/security" | "/admin/announcements" | "/admin/assignments" | "/admin/assignments/:id" | "/admin/commerce" | "/admin/commerce/products/:id" | "/admin/commerce/orders/:id" | "/admin/commerce/batches/:id";
  };
  ...
  "routes/admin/students.$id.tsx": {
    id: "routes/admin/students.$id";
  ...
  "routes/admin.assignments.tsx": {
    id: "routes/admin.assignments";
    page: "/admin/assignments";
  };
  "routes/admin.assignments.$id.tsx": {
    id: "routes/admin.assignments.$id";
    page: "/admin/assignments/:id";
  };
...
type RouteModules = {
  ...
  "routes/test.email-capture": typeof import("./app/routes/test.email-capture.tsx");
  ...
  "routes/public.study": typeof import("./app/routes/public.study.tsx");
  "routes/public.study.$subjectSlug": typeof import("./app/routes/public.study.$subjectSlug.tsx");
  ...
  "routes/public.curriculum.$slug": typeof import("./app/routes/public.curriculum.$slug.tsx");
  ...
  "routes/student/assignments": typeof import("./app/routes/student/assignments.tsx");
  "routes/student/assignments.$id": typeof import("./app/routes/student/assignments.$id.tsx");
  ...
  "routes/admin.search": typeof import("./app/routes/admin.search.tsx");
  "routes/admin.users": typeof import("./app/routes/admin.users.tsx");
  "routes/admin.teachers": typeof import("./app/routes/admin.teachers.tsx");
  "routes/admin.users.$id": typeof import("./app/routes/admin.users.$id.tsx");
  "routes/admin/students.$id": typeof import("./app/routes/admin/students.$id.tsx");
  ...
  "routes/admin.assignments": typeof import("./app/routes/admin.assignments.tsx");
  "routes/admin.assignments.$id": typeof import("./app/routes/admin.assignments.$id.tsx");
